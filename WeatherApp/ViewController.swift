...
class ViewController: UIViewController, UISearchBarDelegate {
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        let urlRequest = URLRequest(url: URL(string: "http://api.apixu.com/v1/current.json?key=57592b9d9bda4fcc851180455180307&q=\(searchBar.text!.replacingOccurrences(of: " ", with: "%20"))")!)
